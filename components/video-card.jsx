...
export function VideoCard({ video, onPlay, onBookmark }) {
    ...
    <Card className="group cursor-pointer overflow-hidden transition-all duration-300 hover:shadow-lg hover:scale-[1.02]">
      <CardContent className="p-0">
        ...
        >
          ...
          {/* Difficulty badge */}
          <Badge
            className={`absolute top-2 left-2 text-xs ${getDifficultyColor(video.difficulty)}`}
          >
        ...
        <div className="p-4">
          ...
          <div className="flex items-center justify-between">
            ...
            {onBookmark && (
              ...
              >
                <Star
                  className={`h-4 w-4 ${video.isBookmarked ? "fill-current text-yellow-500" : ""}`}
                />
              </Button>
            )}
          </div>
