...
function WatchPageContent() {
  ...
  useEffect(() => {
    ...
    setVideoData({
      ...
      description:
        "This is a placeholder description for the educational video.",
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="flex flex-col lg:flex-row h-auto lg:h-[calc(100vh-80px)] w-full">
        ...
        <div
          className={`${playlist ? "flex-1 min-w-0" : "w-full"} flex flex-col`}
        >
          <div
            className="flex-1 px-3 sm:px-6 lg:px-14 py-4 overflow-y-auto scrollbar-hide"
